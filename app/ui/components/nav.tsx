...
export default function Nav() {
    return (
        <nav className="shadow-sm">
            <div className="py-10 w-11/12 mx-auto flex justify-around items-center tracking-widest ">
                {/* desktop */}
                <MagnifyingGlassIcon className="h-6 hidden md:block" />
                {/* mobile */}
                <Bars3CenterLeftIcon className="h-6 md:hidden" />
                ...
                <div className="w-1/2 mx-auto flex justify-center md:justify-between">    
                    ...
                    <Link 
                        href="/"
                        className={`${lusitana.className} text-4xl font-black`}
                        >
                        Leopard
                    </Link>
                    <ul className="w-full justify-evenly items-center hidden md:max-lg:flex-col md:flex">
                ...
                {/* mobile */}
                <MagnifyingGlassIcon className="h-6 pointer block md:hidden" />
                {/* desktop */}
                <UserIcon className="h-6 px-2 hidden md:block" />
                <ShoppingBagIcon className="h-6 px-2" />

                {/* mobile */}
                <div className="h-screen hidden w-full inset-y-0 bg-white fixed opacity-50 z-index-40"></div>
                <div className="h-screen hidden w-11/12 sm:w-96 inset-y-0 inset-x-0 bg-white fixed z-50 px-4 py-4 flex flex-col space-y-4 divide-y">
                ...
                {/* mobile */}
                <div className="h-screen hidden w-full inset-y-0 bg-white fixed opacity-50 z-index-40"></div>
                <div className="h-screen hidden w-11/12 sm:w-96 inset-y-0 inset-x-0 right-0 bg-white fixed z-50 px-4 py-4 flex flex-col space-y-4 divide-y">
                    <h2>CART</h2>    
                    <XMarkIcon className="h-6" />
